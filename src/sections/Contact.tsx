...
export default function Contact() {
  ...
  return (
    ...
    >
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center gap-4 glass rounded-xl p-4">
                ...
                <div>
                  ...
                  <a href="mailto:hello@mumtaz.dev" className="text-white hover:text-orange-400 transition-colors">
                    hello@mumtaz.dev
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 glass rounded-xl p-4">
                ...
                <div>
                  ...
                  <a href="tel:+6281234567890" className="text-white hover:text-orange-400 transition-colors">
                    +62 812 3456 7890
                  </a>
                </div>
              </div>
                ...
                {socialLinks.map((social) => {
                  ...
                  return (
                    <a
                      ...
                      className={`group p-3 glass rounded-xl text-gray-400 transition-all duration-300 ${social.color} hover:text-white hover:scale-110`}
      ...
      {/* Footer */}
      <footer className="relative z-10 mt-20 pt-10 border-t border-white/10">
